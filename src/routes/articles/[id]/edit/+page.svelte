...
<svelte:head>
    <title>Edit Article: {data.article ? data.article.hed : 'Loading...'} - The Daily Pilgrim</title>
</svelte:head>

<div class="hero">
    <h1>Edit Article</h1>
    <p>Update your article content and author attribution</p>
</div>
...
<div class="main-content">
    <nav class="breadcrumb">
        ...
        <span>→</span>
        <a href="/articles/{data.articleId}">{data.article ? data.article.hed : 'Article'}</a>
        <span>→</span>
        <span>Edit</span>
    </nav>
